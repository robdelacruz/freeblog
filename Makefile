...
JSFILES = index.js helpers.js Dashboard.svelte Entries.svelte EditEntry.svelte DelEntry.svelte UploadImages.svelte SearchImages.svelte FileThumbnail.svelte PopupMenu.svelte Tablinks.svelte
