...
JSFILES = index.js helpers.js Dashboard.svelte Entries.svelte EditEntry.svelte DelEntry.svelte Images.svelte EditImage.svelte DelImage.svelte Files.svelte EditFile.svelte DelFile.svelte AccountMenu.svelte ChangePassword.svelte DelUser.svelte UploadImages.svelte SearchImages.svelte FileThumbnail.svelte FileLink.svelte PopupMenu.svelte Tablinks.svelte
